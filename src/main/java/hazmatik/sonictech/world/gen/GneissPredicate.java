...
public class GneissPredicate implements Predicate<IBlockState>
{
	@Override
	public boolean apply(IBlockState input)
	{
		return input != null && input == BlockInit.STONE.getDefaultState().withProperty(BlockSTStone.VARIANT, StoneType.GNEISS);
	}
}
