...
public abstract class SlabChromititeBrick extends BlockSlab
{
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
	
	public SlabChromititeBrick(String name)
	{
		super(Material.ROCK);
	...
	{
		return Item.getItemFromBlock(SlabInit.SLAB_CHROMITITE_BRICK_HALF);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) 
	{
		return new ItemStack(SlabInit.SLAB_CHROMITITE_BRICK_HALF);
	}
	...
	public static class DoubleCS extends SlabChromititeBrick
	{
	...
	public static class HalfCS extends SlabChromititeBrick
	{
