...
public abstract class SlabChromitite extends BlockSlab
{
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
	
	public SlabChromitite(String name)
	{
		super(Material.ROCK);
	...
	{
		return Item.getItemFromBlock(SlabInit.SLAB_CHROMITITE_HALF);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) 
	{
		return new ItemStack(SlabInit.SLAB_CHROMITITE_HALF);
	}
	...
	public static class DoubleCS extends SlabChromitite
	{
	...
	public static class HalfCS extends SlabChromitite
	{
