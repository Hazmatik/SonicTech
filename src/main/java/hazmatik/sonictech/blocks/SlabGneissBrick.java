...
public abstract class SlabGneissBrick extends BlockSlab
{
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
	
	public SlabGneissBrick(String name)
	{
		super(Material.ROCK);
	...
	{
		return Item.getItemFromBlock(SlabInit.SLAB_GNEISS_BRICK_HALF);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) 
	{
		return new ItemStack(SlabInit.SLAB_GNEISS_BRICK_HALF);
	}
	...
	public static class DoubleCS extends SlabGneissBrick
	{
	...
	public static class HalfCS extends SlabGneissBrick
	{
